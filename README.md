...
- 双方各有 3 个召唤槽，围绕人物立绘呈三角形站位，敌方左右镜像。五张基础召唤牌消耗 2 点对应属性灵气，召唤 15 生命的物体；物体在持有者回合开始时产生 1 点相生属性灵气。召唤物不获得状态，也不受五行抗性与克制影响。伤害牌可自由指定敌方角色或召唤物；可选目标只显示小准星，多段伤害预览按结算顺序逐段显示，并计入护盾和剩余生命。
